        ...
        <Tabs defaultValue="performance" className="w-full">
          ...
          <TabsContent value="payments" className="space-y-6">
              ...
              <CardContent>
                ...
                >
                  ...
                  >
                    ...
                    <Tooltip content={(props) => <ChartTooltipContent {...(props as any)} />} />
                    <Legend />
                    <Bar dataKey="payé" stackId="a" fill="#33C3F0" name="Payé (%)" />
                    <Bar dataKey="nonPayé" stackId="a" fill="#FF6384" name="Non payé (%)" />
                  </BarChart>
                </ChartContainer>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Card className="bg-skyblue/10">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-muted-foreground">Montant recouvré</CardTitle>
                  <div className="text-2xl font-bold">15.6M FCFA</div>
                </CardHeader>
              </Card>
              <Card className="bg-skyblue/10">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-muted-foreground">Montant à recouvrer</CardTitle>
